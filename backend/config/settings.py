...
SUPPORT_NOTIFICATIONS_EMAIL = os.getenv("SUPPORT_NOTIFICATIONS_EMAIL", SUPPORT_EMAIL)
COURIER_DISPATCH_OFFER_TIMEOUT_SECONDS = int(os.getenv("COURIER_DISPATCH_OFFER_TIMEOUT_SECONDS", "30"))
COURIER_LOCATION_MAX_AGE_SECONDS = int(os.getenv("COURIER_LOCATION_MAX_AGE_SECONDS", "300"))
