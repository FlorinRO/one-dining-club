...
const ro: Dictionary = {
  ...
  "settings.delete.message": "Contul tău va fi șters sau închis definitiv, iar sesiunea curentă va fi eliminată. Vrei să continui?",
  "settings.delete.confirm": "Șterge contul",
  "settings.deleting": "Se șterge...",
  "settings.delete.error.title": "Nu am putut șterge contul",
  "settings.delete.error.message": "Încearcă din nou în câteva momente.",
...
const en: Dictionary = {
  ...
  "settings.delete.message": "Your account will be permanently deleted or closed, and the current session will be removed. Do you want to continue?",
  "settings.delete.confirm": "Delete account",
  "settings.deleting": "Deleting...",
  "settings.delete.error.title": "We could not delete the account",
  "settings.delete.error.message": "Please try again in a moment.",
